...
> **Note**: The exact message format depends on the upstream receiver (droneid-go, dragonsdr_dji_droneid). Refer to those repositories for authoritative field documentation.
...
- **dragonsdr_dji_droneid**: [github.com/alphafox02/dragonsdr_dji_droneid](https://github.com/alphafox02/dragonsdr_dji_droneid) - DJI firmware and dji_receiver
